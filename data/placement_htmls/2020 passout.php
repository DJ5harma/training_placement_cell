    ...
    <table cellspacing="0" cellpadding="0">
        <tbody>
            <tr>
                ...
                <td class="s1">
                    <div style="width:167px;left:-3px">Package in LPA</div>
                </td>
            </tr>
            <tr>
                <td class="s2"></td>
            ...
            <tr>
                <td class="s2">Kaptan Singh</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Vivek Kumar</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Anjali Juyal</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="s2">Abhishek Bagga</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Ridhima Kandhari</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="s2">Krishan Gopal Yadav</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="s2">Yogesh Na</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Vickram Saini</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="s2">Nidhi Soni</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Rashmi Rohila</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Dikshant Anthal</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Aditya Bhat</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Deepak Malik</td>
                <td class="s2">8</td>
            </tr>
            <tr>
                <td class="s2">Kumari Monika</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="s2">Sachin Lather</td>
                <td class="s2">5</td>
            </tr>
            <tr>
                <td class="s2">Saurabh Saurabh</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="s2">Nisha Rani</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Naresh Saharan</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="s2">Sumit Tyagi</td>
                <td class="s2">5</td>
            </tr>
            <tr>
                <td class="s2">Satyam Kumar</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="s2">Arjun Singh Mor</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="s2">Sumit Kataria</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Rhythm Bhatia</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Mohit Malik</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Gurkirat Singh</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Bhavy Sharma</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Devashish Garg</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Rohit Dabas</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Shubham Gahlyan</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Priyanka Goyal</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Chhavi Kant Gaur</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2">Gourav Kumar</td>
                <td class="s2">3.6</td>
            </tr>
            <tr>
                <td class="s2"></td>
            ...
            <tr>
                <td class="s3">Hughes Systique</td>
                <td class="s4"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="s3">BYJU&#39;S think and learn</td>
                <td class="s4"></td>
            </tr>
            <tr>
                <td class="s2">Tanishq kokcha </td>
