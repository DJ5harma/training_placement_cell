...
<div>
    <table>
        <tbody>
            ...
            <tr style="height: 20px">
                <td class="s2">Beri Udyog (Fieldking)</td>
                <td class="s2"></td>
            </tr>
            <tr style="height: 20px">
            ...
            <tr style="height: 20px">
                <td class="s2">Iron Network Pvt. Ltd.</td>
                <td class="s2"></td>
            </tr>
            <tr style="height: 20px">
            ...
            <tr style="height: 20px">
                <td class="s2">Planet Spark Pvt. Ltd.</td>
                <td class="s2"></td>
            </tr>
            <tr style="height: 20px">
            ...
            <tr style="height: 20px">
                <td class="s2">Sonalika Pvt. Ltd.</td>
                <td class="s2"></td>
            </tr>
            <tr style="height: 20px">
